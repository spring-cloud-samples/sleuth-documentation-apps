...
kill_app_at_port ${SERVICE3_PORT} && echo "Killed app at port ${SERVICE3_PORT}" || echo "Failed to kill service"
kill_app_at_port ${SERVICE4_PORT} && echo "Killed app at port ${SERVICE4_PORT}" || echo "Failed to kill service"
